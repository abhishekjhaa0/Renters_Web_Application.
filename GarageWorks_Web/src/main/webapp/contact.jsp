...
<body>
    ...
    <section class="container">
        <iframe class="w-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.210774657842!2d77.51348155043733!3d28.47319838239494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cea7e051fd949%3A0xefccd5003c9032b6!2sINCAPP!5e0!3m2!1sen!2sin!4v1628422705716!5m2!1sen!2sin" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </section>
    <section class="container">
        <div class="row text-center p-5">
            <div class="col-sm border p-3">
                <h3><i class="fas fa-phone-square-alt"></i> Contact Numbers:</h3>
                <p>9811XXXXXX</p>
                <p>9811XXXXXX</p>
                <p>9811XXXXXX</p>
            </div>
            <div class="col-sm border p-3">
                <h3><i class="fas fa-envelope-square"></i> Email Address:</h3>
            <p>ELECTRO@GMAIL.COM</p>
            <p>INFO-ELECTRO@GMAIL.COM</p>
            <p>SUPPORT-ELECTRO@GMAIL.COM</p>
            </div>
            <div class="col-sm border p-3">
                <h3><i class="fas fa-map-marker-alt"></i> Office Address:</h3>
            <p>Om Tower, 503, 5th Floor, Alpha-I Commercial Belt, Greater Noida, Uttar Pradesh 201308</p>
            </div>
        </div>
    </section>
    <footer>
