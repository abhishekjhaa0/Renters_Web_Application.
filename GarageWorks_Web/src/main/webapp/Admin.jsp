...
<body>
    ...
    <p style="background-color: yellow;color:black;" > ${adminLoginResult} </p>
    	...
    	<div class="row">
    		<div class="col-sm p-3 my-4 border">
    			...
    			<form action="adminLogin" method="post" >
		            <div class="py-2">
		                <input name="id" class="form-control" type="text" placeholder="Admin Id" maxlength="20" required />
		            </div>
		            <div class="py-2">
		                <input name="password" class="form-control" type="password" placeholder="Admin Password" maxlength="20"  required />
		            </div>
		            <div class="py-2">
