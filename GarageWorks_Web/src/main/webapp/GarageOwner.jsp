...
<body>
    ...
    <p style="background-color: yellow;color:black;" > ${garageResult} </p>
    	...
    	<div class="row">
    		...
    		<div class="col-sm p-3 my-4 border">
    			...
    			<form action="AddGarageOwner" method="post" enctype="multipart/form-data" >
		            ...
		            <div class="py-2">
		                <input name="gname" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Your Garage Name" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="phone" class="form-control" type="tel" pattern="[0-9]+" placeholder="Your Phone" maxlength="10" minlength="10" required />
		            </div>
		            <div class="py-2">
		                <input name="state" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Your State" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="city" class="form-control" type="text"  pattern="[a-zA-Z ]+" placeholder="Your City" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="secVill" class="form-control" type="text"   placeholder="Your Sector/Village" maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="shopNo" class="form-control" type="text"   placeholder="Your Shop No." maxlength="80" required />
		            </div>
		            <div class="py-2">
		                <input name="password" class="form-control" type="password" placeholder="Your Password" required />
		            </div>
		            <div class="py-2">
		                <input name="photo1" class="form-control" type="file" accept=".jpg,.png" required />
		            </div>
		            <div class="py-2">
		                <input name="photo2" class="form-control" type="file" accept=".jpg,.png" required />
		            </div>
		            <div class="py-2">
