...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top px-4">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <div>
                Welcome: <b> ${uname} </b>
                <img src="getPhoto?email=${email}" height="30px"/>
    ...
    <section class="container py-4">
    	<h3>Search Garage</h3>
    	<form action="getAllGarageByStateCity" method="get" >
            <div class="py-2">
        ...
        <c:forEach items="${allGarages}" var="g">
   			<div class="bg-light p-2 m-2">
   				...
   				<a class="btn btn-dark btn-sm" href="GarageDetails?email=${g.email}">More Details</a>
   			</div>
   		</c:forEach>
    </section>
